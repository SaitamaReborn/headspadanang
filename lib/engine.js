...
<h2>The ${top.length} best ${b.noun} in Da Nang</h2>
...
<p class="bl-a"><a href="${LISTING.path}${p.slug}/">Hours, map and reviews →</a>${p.maps?` · <a href="${p.maps}" rel="noopener nofollow">Google Maps</a>`:''}</p>
</div>
